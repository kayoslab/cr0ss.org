...
cr0ss.org is a Next.js 15 application using the App Router with a headless CMS (Contentful), serverless database (Neon PostgreSQL), search platform (Algolia), and AI chat assistant powered by Vercel AI Gateway.
...
- **Node Runtime for AI** - Use `export const runtime = "nodejs"` for AI Gateway routes
