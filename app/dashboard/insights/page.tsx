    ...
    <div className='w-full space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>
          Discover statistically significant correlations in the quantified self
          data
        </p>
      </div>
        ...
        <Card>
          <CardHeader>
            ...
            <p className='text-muted-foreground mt-1 text-sm'>
              This correlation engine analyzes the daily metrics to find
              meaningful patterns.
            </p>
          </CardHeader>
          <CardContent className='space-y-2 text-sm'>
            <p>
              <strong>Statistical Analysis:</strong> Uses Pearson correlation
            ...
            <ul className='text-muted-foreground ml-4 list-inside list-disc space-y-1'>
              <li>
                <strong>Strong</strong> (p &lt; 0.01): 99% confidence the
                correlation is real
              </li>
              <li>
                <strong>Moderate</strong> (p &lt; 0.05): 95% confidence
              </li>
              <li>
                <strong>Exploratory</strong> (p &lt; 0.1): 90% confidence
              </li>
            </ul>
            <p className='text-muted-foreground mt-2'>
              Correlation does not imply causation. These insights show{' '}
              <em>associations</em>
